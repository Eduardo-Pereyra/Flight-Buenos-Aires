...
function redirectToPayment() {
    // Get the selected airline price
    const airlinePrice = document.getElementById("airline").value;

    // Get the total price of selected seats
    const totalPrice = document.getElementById("total").textContent;

    // Construct the payment link with the total price
    const paymentLink = `https://www.linkedin.com/in/eduardo-pereyra35/`;
